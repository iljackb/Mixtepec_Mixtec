   ...
   <xsl:template match="w">
      ...
      <p>
         ...
         <xsl:for-each select="$spanTranslations">
            <i><xsl:text>Span: </xsl:text><!-- remove later --></i>
         ...
         <xsl:for-each select="$literalSpanTranslations">
            <i><xsl:text>Literal span: </xsl:text><!-- remove later --></i>
            <xsl:variable name="spanLang" select="@xml:lang"/>
         ...
         <xsl:for-each select="$linkTranslations">
            <i><b><xsl:text> Links (</xsl:text><!-- remove later -->
         ...
         <xsl:for-each select="$literalLinkTranslations">
            <i><xsl:text> Literal links: </xsl:text><!-- remove later --></i>
