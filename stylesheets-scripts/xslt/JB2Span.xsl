...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 -->
    ...
    <!-- Works for utterance files where no annotations already there -->
        ...
        <xsl:for-each select=".">
            ...
            <spanGrp type="annotations">
                <xsl:for-each select="seg[@type = 'S' and @notation = 'orth']">
                    ...
                    <span type="translation" target="#{$orthID}" xml:lang="en" ana="#S"/>
                    <span type="translation" target="#{$orthID}" xml:lang="es" ana="#S"/>
                ...
                <xsl:for-each select="seg[@notation = 'orth']/w">
                    ...
                    <span type="translation" target="#{$wID}" xml:lang="en"/>
                    <span type="translation" target="#{$wID}" xml:lang="es"/>
    ...
    <xsl:template match="span[@type = 'translation' and @xml:lang = 'es']">
        <xsl:for-each select=".">
            ...
            <span type="gram" target="{$targetID}" ana="#">
                <gloss type="igt"/>
            </span>
