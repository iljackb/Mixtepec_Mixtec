                    ...
                    <body>
                        ...
                        <xsl:for-each-group select="$praat-parsed" group-starting-with="Tokens">
                            ...
                            <xsl:variable name="whens" as="element()*">
                                ...
                                <xsl:for-each select="
                                    distinct-values(
                                    (current-group()[self::Mixtec|self::Spanish|self::IPA|self::English]/@start, current-group()[self::Esp]/@end)
                                    )">
                            ...
                            <annotationBlock>
                                <u n="{current-group()[1]}" xml:id="{generate-id(.)}"><!-- ID's ok-->
                                    ...
                                    <seg function="utterance" notation="orth"  xml:lang="mix"  xml:id="{concat('T','-seg-orth-',@start)}"><!--concat(tier+timestamp) -->
                                    ...
                                    <seg function="utterance" xml:lang="mix" notation="ipa" xml:id="{concat('T','-seg-pron-',@start)}">
