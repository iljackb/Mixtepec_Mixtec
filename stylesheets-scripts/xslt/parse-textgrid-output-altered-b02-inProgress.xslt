    ...
    <xsl:variable name="teiHeader">
        <teiHeader>
            <fileDesc>
                ...
                <notesStmt>
                    <note>One of these files should be made for each .txt file output from a Praat TextGrid. Where the .txt file (and thus the source recording) has multiple tokens of same utterance,
                        each utterance should be represented as its own <gi>annotationBlock</gi>. Each utterance should likewise have its own timeline that spans the duration of its segment</note>
                </notesStmt>
                <sourceDesc>
