...
declare function local:query($term, $lang,$mode) {
    switch($mode)
      case 'case-insensitive' return db:open("Tisu-Vienna-Diary-201711")//*[contains(lower-case(.), lower-case($term))][ancestor-or-self::*/@lang[. = $lang]]
      case 'exact' return db:open("Tisu-Vienna-Diary-201711")//*[. = $term][ancestor-or-self::*/@lang[. = $lang]]
      default return db:open("Tisu-Vienna-Diary-201711")//*[contains(., $term)][ancestor-or-self::*/@lang[. = $lang]]
};
